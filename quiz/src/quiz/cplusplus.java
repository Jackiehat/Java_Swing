...
public class cplusplus extends javax.swing.JFrame {
        String[] questions = {"1.WHO INVENTD C++ ?","2.C++ IS ________ ?","3.WHICH OF THE FOLLOWING USER-DEFINED HEADER FILE EXTENSION USED IN C++ ?","4.WHICH OF THE FOLLOWING IS A CORRECT IDENTIFIER IN C++ ?","5.WHICH OF THE FOLLOWING APPROACH IS USED BY C++ ?"};
        String [][] options = {{"DENNIS RITCHIE","KEN THOMPSON","BRIAN KERNIGHAN","BJARNE STROUSTRUP","BJARNE STROUSTRUP"},{"OBJECT ORIENTED PROGRAMMING LANGUAGE","PROCEDURAL PROGRAMMING LANGUAGE ","BOTH PROCEDURAL AND OBJECT ORIENTED PROGRAMMING LANGUAGE","FUNCTIONAL PROGRAMMING LANGUAGE","BOTH PROCEDURAL AND OBJECT ORIENTED PROGRAMMING LANGUAGE"},{"hg","cpp","h","hf","h"},{"VAR_1234","$var_name","7VARNAME","7var_name","VAR_1234"},{"LEFT-RIGHT","RIGHT-LEFT","BOTTOM-UP","TOP-DOWN","BOTTOM-UP"}};
