...
public class html extends javax.swing.JFrame {
        String[] questions = {"1. HTML stands for - ","2.The correct sequence of HTML tags for starting a webpage is - ","3.Which of the following element is responsible for making the text bold in HTML?","4. Which of the following tag is used for inserting the largest heading in HTML?","5.Which of the following tag is used to insert a line-break in HTML?"};
        String [][] options = {{"HighText Machine Language","HyperText and links Markup Language","HyperText Markup Language","None of these","HyperText Markup Language"},{"Head, Title, HTML, body","HTML, Body, Title, Head","HTML, Head, Title, Body","HTML, Head, Title, Body","HTML, Head, Title, Body"},{"<pre>","<a>","<b>","<br>","<b>"},{"<h3>","<h1>","<h5>","<h6>","<h1>"},{"<br>","<a>","<pre>","<b>","<br>"}};
