...
public class javaquiz extends javax.swing.JFrame {
        String[] questions = {"1.Who invented Java Programming?","2.. Which component is used to compile, debug and execute the java programs?","3.Which one of the following is not a Java feature?","4. Which of these cannot be used for a variable name in Java?","5.What is the extension of java code files?"};
        String [][] options = {{" Guido van Rossum","JAMES GOSLING","DENNIS RITCHIE"," Bjarne Stroustrup","JAMES GOSLING"},{"JRE","JIT","JDK","JVM","JDK;"},{"Portable","Object Oriented","Use Of Pointers","Dynamic and Extensible","Use Of Pointers"},{"Identifiers","Identifiers and Keywords","Keywords","None Of The Above Mentioned","Keywords"},{".class",".java",".js",".txt",".java"}};
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setVerticalGroup(
            jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(l1, javax.swing.GroupLayout.DEFAULT_SIZE, 252, Short.MAX_VALUE)
        );
